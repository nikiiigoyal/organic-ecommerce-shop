        ...
        <div className="container mx-auto flex justify-around items-center">
          ...
          <div className="relative">
            <input
              ...
              className="px-4 py-3 w-80 border border-gray-300 rounded-full h-[52px] focus:outline-none"
            />
            <button className="bg-[#00B207] text-white px-6 py-3 rounded-full absolute right-[-1px] top-1/2 transform -translate-y-1/2 hover:bg-green-600 transition duration-300">
              Subscribe
            </button>
          </div>
          <div className="flex ">
            <a
              href="#"
              className="w-10 h-10  rounded-full flex items-center justify-center ml-[15px] bg-transparent"
            >
        ...
        <div className="container mx-auto grid grid-cols-5 gap-6">
          <div className="col-span-1 ml-16">
            ...
            <p className="text-gray-400">
              <span className="text-white font-semibold border-b-2 border-[#20B526] text-sm">
                (219) 555-0114
              </span>{' '}
              or{' '}
              <span className="text-white font-semibold border-b-2 border-[#20B526] text-sm">
