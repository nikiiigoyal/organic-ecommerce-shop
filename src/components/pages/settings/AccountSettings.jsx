    ...
    <>
      <div className="border border-gray-100 font-poppins rounded-lg w-[70%]">
        <div className="flex flex-col border border-b-[#E5E5E5] p-5">
          <h1 className="text-[#1A1A1A] text-[20px] rounded-md font-semibold">
            Account Settings
          </h1>
        </div>
        <div className="flex flex-row justify-around my-4">
          <div className="flex flex-col">
            <label>
              ...
              <input
                placeholder="Dianne"
                className="p-4 text-[#666666] border border-[#E6E6E6] rounded-md"
              ></input>
            </label>
            <label>
          ...
          <div className="flex flex-col">
            ...
            <button className="text-[#00B207] border border-[#00B207] rounded-full px-5 py-2 text-sm">
              Chose Image
            </button>
          </div>
        </div>
