      ...
      <div className="font-poppins fixed inset-0 flex items-center justify-center z-50 ">
        ...
        <div className="flex min-h-full items-center justify-center p-">
          <div className="relative bg-white w-full max-w-[90%] rounded-lg">
            {/* close button */}
            <button
              className="absolute right-4 top-[-32px] hover:bg-gray-100 bg-black rounded-full z-10"
              onClick={onClose}
            >
                ...
                <div className="flex flex-row text-sm justify-between">
                  ...
                  <div className="flex items-center gap-4 ">
                    ...
                    <div className="flex">
                      <a
                        href="#"
                        className="w-10 h-10 bg-white rounded-full flex items-center justify-center ml-[15px]"
                      >
