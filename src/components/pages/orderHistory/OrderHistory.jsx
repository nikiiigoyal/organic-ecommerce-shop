...
const OrderHistoryTable = ({ orders }) => {
    return (
        ...
        <div className="flex flex-row justify-between">
          <h1 className="text-[#1A1A1A] font-semibold text-[20px] py-5">Recent Order History</h1>
    ...
    <tr key={order.id}>
        ...
        <td className="text-[#20B526] text-sm"><a href={`/orders/${order.id}`}>View Details</a></td>
    </tr>
))}
    </tbody>
        </table>
