const TestimonialCard = () => {
  ...
  return (
    <div className=" w-full max-w-[1320px] font-poppins mx-auto px-4 py-12 bg-[#F2F2F2]">
      ...
      <div className="flex space-x-6 overflow-x-auto rounded-md pb-4">
        {testimonials.map((testimonial) => (
          <div
            key={testimonial.id}
            className="bg-white rounded-lg shadow-md p-6 flex flex-col min-w-[300px] max-w-[400px]"
          >
            <div className="mb-5">
              <img src="/images/comma.png" className=""></img>
            </div>
