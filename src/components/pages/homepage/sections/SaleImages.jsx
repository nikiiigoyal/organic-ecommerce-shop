...
const SaleImages = () => {
  return (
    <div className="container flex justify-around w-full max-w-[1320px] mx-auto font-poppins space-x-6">
      {/* First Banner */}
      <div className="bg-[url('/images/bannerbg1.png')] bg-cover bg-center p-6 text-white flex flex-col h-[450px] w-[400px]">
      ...
      {/* Second Banner */}
      <div className="bg-[url('/images/bannerbg2.png')] bg-cover bg-center p-6 text-white flex flex-col h-[450px] w-[400px]">
        ...
        <p className="text-center text-white text-xl font-bold pb-2">
          Started at <span className="text-[#FF8A00] text-xl">$79.99</span>
        </p>
      ...
      {/* Third Banner */}
      <div className="bg-[url('/images/bannerbg3.png')] bg-cover bg-center p-6  flex flex-col h-[450px] w-[400px] ">
        <h3 className="text-sm text-center text-black pb-2">Summer Sale</h3>
        <h1 className="text-2xl text-center text-bold pb-2">
          100% Fresh Fruit
        </h1>
        <p className="text-center text-xl font-bold pb-2">
          Up to{' '}
          <span className="w-[100px] bg-black text-[#FCC900] p-2 text-[18px] text-center ">
            64% OFF
          </span>
        </p>
