    ...
    <div className="container mx-auto p-4 w-full max-w-[1320px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-2 row-span-2 border border-green-200 rounded-lg p-4">
            ...
            <div className="mt-4 flex justify-around">
              ...
              <button className="bg-[#00B207] text-white py-2 w-[60%] rounded-full flex items-center justify-center">
                Add to Cart{' '}
                <img src="/images/addToCart.png" className="pl-6"></img>
              </button>
              <img src="/images/eye.png"></img>
            </div>
            {/*name  */}
            <div className="mt-4 flex flex-col items-center">
              <h3 className="text-[18px] text-[#2C742F] font-semibold">
        ...
        {otherProducts.map((product) => (
          <div
            key={product.id}
            className="border p-4 rounded shadow-md relative flex flex-col hover:border-green-500 transition duration-300 h-fit"
          >
            ...
            <div className="flex justify-between items-center">
              <div>
                <h2 className="text-[14px] text-gray-700 font-semibold mt-2">
                  {product.name}
                </h2>
                ...
                {product.sale && (
                  <span className="text-white text-center absolute top-2 left-2 bg-[#EA4B48] p-1">
                    {product.sale}% OFF
                  </span>
                )}
                <div className="flex items-center mt-2">
              ...
              <div className="relative group-hover:bg-green-500 p-1 rounded-full transition-all duration-300">
                <img
                  ...
                  alt="add to cart"
                  className="w-8 h-8 group-hover:opacity-90"
                />
              </div>
            </div>
          </div>
