      ...
      <div className="flex flex-col bg-gray-50 items-center h-fit font-poppins mb-7">
        <div className="top flex flex-row w-[90%] mx-auto justify-around mt-5 ">
          ...
          <div className="right w-[60%]  rounded-lg flex flex-col justify-between p-4 shadow-[0px,0px,56px,0px,#00260314] bg-white">
            <h2 className="font-bold text-lg text-black py-5">
              Just Say Hello!
            </h2>
            <p className="text-sm text-[#808080] mb-4 w-[50%]">
              {' '}
            ...
            <div className="flex flex-row justify-between mb-5">
              <input
                className="border w-[40%] border-[#E6E6E6] text-sm text-gray-600 p-3"
                placeholder="Template Cookie"
              ></input>
              <input
                className="border border-[#E6E6E6] text-sm text-gray-600 p-3 w-[50%]"
                type="email"
            ...
            <input
              ...
              type="email"
            />
            <textarea className="w-full border border-[#E6E6E6] text-gray-700 p-3 rounded-md mb-3">
              Subjects
            </textarea>
            <button className="rounded-full py-3 px-2 text-white bg-[#00B207] w-[20%]">
              Send Message
            </button>
          </div>
        </div>
